...
import { Briefcase, CheckCircle2, Loader2, UserRound } from 'lucide-react';
...
export default function Cadastro() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      {/* painel de marca */}
      <BrandPanel title={<>Cadastre seu condomínio e <span className="text-gradient">comece agora.</span></>}>
